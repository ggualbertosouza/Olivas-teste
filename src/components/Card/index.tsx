...
export const Card = ({ description, title, link }: postProps) => {
  return (
    <section className="flex flex-col w-[10rem] lg:w-[20rem] h-auto justify-between shadow-sm shadow-black p-1 hover:-translate-y-1 hover:translate-x-1 cursor-pointer">
